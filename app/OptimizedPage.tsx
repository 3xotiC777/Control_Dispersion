...
export default function OptimizedPage() {
  ...
  return <main className="app-shell"><div className="page-container">
    <header className="site-header animate-fade-up"><span className="brand-pill"><Layers3 size={14} /> Base de puntos + Forecast</span><h1><span>Ruta Compacta</span> para operación de campo</h1><p>Planifica titulares por cercanía, ejecuta un QA vial automático inteligente y completa cada jornada con suplentes priorizados.</p></header>
