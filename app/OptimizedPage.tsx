...
export default function OptimizedPage() {
  ...
  const filterKey = useMemo(() => `${planningVersion}|${mt}|${selectedDays.join(",")}|${kind}|${selectionFilter}`, [planningVersion, mt, selectedDays, kind, selectionFilter]);
  ...
  return <main className="app-shell"><div className="page-container">
    ...
    {!!points.length && <div className="results animate-fade-up">
      ...
      <div className="map-layout">
        <aside className="filters-panel" ref={filtersRef}>
